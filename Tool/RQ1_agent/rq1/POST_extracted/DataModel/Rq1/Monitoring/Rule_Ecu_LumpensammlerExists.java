 ...
 * @author gug2wi
 */
public class Rule_Ecu_LumpensammlerExists extends DmRule<DmRq1SwCustomerProject_Leaf> {
    ...
    public void executeRule() {
        ...
        for (DmRq1Pst release : dmElement.ALL_PST.getElementList()) {
        ...
        addMarker(dmElement, new Warning_LumpensammlerMissing(this, dmElement));
    }
}
