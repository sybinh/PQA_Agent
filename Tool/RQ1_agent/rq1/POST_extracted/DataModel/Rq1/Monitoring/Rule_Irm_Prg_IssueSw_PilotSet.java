 ...
 * @author gug2wi
 */
public class Rule_Irm_Prg_IssueSw_PilotSet extends DmRule<DmRq1Irm_Pst_IssueSw> {
    ...
    public void executeRule() {
        ...
        //
        if (dmElement.HAS_MAPPED_RELEASE.getElement() instanceof DmRq1Pst) {

            if (EnumSet.of(YesNoEmpty.NO, YesNoEmpty.YES).contains(dmElement.IS_PILOT.getValue()) == false) {
                addMarker(dmElement, new Warning(this, "Pilot not set.", dmElement.getTypeIdTitle())
