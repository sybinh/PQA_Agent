 ...
 * @author gug2wi
 */
public class Rule_Bc_NamingConvention extends DmRule<DmRq1BcRelease> {
    ...
    static final public DmRq1RuleDescription description = new DmRq1RuleDescription(
            ...
            + "b) BC_MO : (Mo|SftyHw) / <VersionNumber>\n"
            ...
            + "\n"
            + "<NameOfComponent> ... Only characters and numbers allowed.\n"
            + "\n"
    ...
    static boolean isTitleOk(String title) {
        ...
        boolean ok = title.matches("((BC|BCC) *: *([a-zA-Z_0-9]+) */ *[0-9]+(\\.[0-9]+){0,2}(_[a-zA-Z0-9_\\.]*)? *)"
                + "|"
                + "(BC_MO *: *(Mo|MoVW|SftyHw) */ *([0-9]+(\\.[0-9]+){0,2}(_[a-zA-Z0-9_\\.]*)?) *)"
                + "|"
    ...
    static final private Pattern matchPattern = Pattern.compile("(BC_MO|BCC|BC|BX|CEL|CC|DX|IC)? *:? *([a-zA-Z0-9_]+)");
