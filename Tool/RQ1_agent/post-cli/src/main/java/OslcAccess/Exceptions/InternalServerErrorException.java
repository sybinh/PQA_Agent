 ...
 * @author gug2wi
 */
public class InternalServerErrorException extends TemporaryServerError {

    final private String additionalInfo;

    public InternalServerErrorException(String additionalInfo) {
    ...
    public String getMessageForUi() {
        ...
        b.append("Internal Server Error.\n"
                + "\n"
                + "Additional Info: ");
