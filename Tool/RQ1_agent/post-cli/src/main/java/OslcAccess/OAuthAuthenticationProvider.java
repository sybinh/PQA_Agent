...
public class OAuthAuthenticationProvider implements AuthenticationProviderI {
    ...
    void setOAuthToken(String oAuthToken, String oAuthTokenSecret) {
    ...
    @Override
    public void setAuthData(HttpMethod httpMethod) throws InternalException {
    ...
    private void setAuthData(HttpMethod httpMethod, String method) throws InternalException {
        assert (httpMethod != null);
        assert (method != null);
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Getting URL string from method URI failed.", ex);
            throw (new InternalException("Getting URL string from method URI failed.", ex));
        }
        ...
        try {
            ...
            throw (new InternalException("Creation of MAC failed.", ex));
        ...
        httpMethod.setRequestHeader("Authorization", "OAuth " + authorizationHeader);
    }
