 ...
 * @author gug2wi
 */
public class EcvLoginWindow extends javax.swing.JDialog {

    final private EcvLoginCustomizer customizer;
    private EcvLoginData loginData = null;

    @SuppressWarnings("unchecked")
    public EcvLoginWindow(GeneralServerDescription[] databases) {
        super(EcvApplication.getMainWindow(), true);
        UiThreadChecker.ensureDispatchThread();
        customizer = new EcvLoginCustomizer();
        ...
        for (GeneralServerDescription d : databases) {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        loginData = new EcvLoginData(loginName, password.getPassword(), (GeneralServerDescription) databaseBox.getSelectedItem());
        customizer.setLoginName(loginNameField.getText());
        setVisible(false);
        dispose();
    }

    public EcvLoginData getLoginData() {
        return (loginData);
    }
