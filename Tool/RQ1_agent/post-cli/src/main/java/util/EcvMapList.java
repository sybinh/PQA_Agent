 ...
 */
public class EcvMapList<KEY extends Comparable<KEY>, VALUE> extends TreeMap<KEY, List<VALUE>> {
     ...
     * @param value
     */
    public EcvMapList(KEY key, VALUE value) {
        add(key, value);
    }
     ...
     *
     */
    public EcvMapList(Collection<KEY> keys) {
        assert (keys != null);
        for (KEY key : keys) {
            add(key);
        }
     ...
     */
    final public EcvMapList<KEY, VALUE> add(KEY key, VALUE value) {
        assert (key != null);
        assert (value != null);
    ...
    final public EcvMapList<KEY, VALUE> addAll(KEY key, List<? extends VALUE> value) {
        assert (key != null);
        assert (value != null);
        List<VALUE> l = get(key);
        if (l == null) {
     ...
     */
    final public EcvMapList<KEY, VALUE> add(KEY key) {
        assert (key != null);
        List<VALUE> l = get(key);
        if (l == null) {
            l = new ArrayList<>();
