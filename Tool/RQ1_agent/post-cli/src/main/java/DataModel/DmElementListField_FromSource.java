 ...
 */
public abstract class DmElementListField_FromSource<T extends DmElementI> extends DmField implements DmElementListFieldI<T> {

    private List<T> elementList = null;

    public DmElementListField_FromSource(String nameForUserInterface) {
