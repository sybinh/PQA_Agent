...
public class DmDoorsObject_PTSA_1x_NonFunctionalRequirement extends DmDoorsObject_PTSA_1x_Requirement {
    ...
    public DmDoorsObject_PTSA_1x_NonFunctionalRequirement(DoorsObject doorsObject) {
