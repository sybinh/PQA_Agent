...
public class DmDoorsObject_DetailedSoftwareRequirement extends DmDoorsObject_Requirement {
    ...
    public DmDoorsObject_DetailedSoftwareRequirement(DoorsObject doorsObject) {
