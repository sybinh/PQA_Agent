...
public class DmDoorsObject_PTSA_1x_SystemRequirement extends DmDoorsObject_PTSA_1x_Requirement {
    ...
    public DmDoorsObject_PTSA_1x_SystemRequirement(DoorsObject doorsObject) {
        super(ElementType.SYSTEM_REQ, doorsObject);
