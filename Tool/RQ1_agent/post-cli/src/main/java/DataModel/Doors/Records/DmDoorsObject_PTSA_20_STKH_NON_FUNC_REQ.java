 ...
 * @author GUG2WI
 */
public class DmDoorsObject_PTSA_20_STKH_NON_FUNC_REQ extends DmDoorsObject_PTSA_20_STKH_REQ {

    final public DmConstantField_Text NF_CATEGORY;

    public DmDoorsObject_PTSA_20_STKH_NON_FUNC_REQ(DoorsObject doorsObject) {
        super(ElementType.PTSA_20_STKH_NON_FUNC_REQ, doorsObject);
