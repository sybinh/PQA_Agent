 ...
 * @author GUG2WI
 */
public class DmDoorsObject_PTSA_20_ATYPE_HEADER extends DmDoorsObject_PTSA_20_ATYPE {

    final public DmConstantField_Text VAR_FUNC_SW;

    public DmDoorsObject_PTSA_20_ATYPE_HEADER(DoorsObject doorsObject) {
        super(ElementType.PTSA_20_ATYPE_HEADER, doorsObject);
