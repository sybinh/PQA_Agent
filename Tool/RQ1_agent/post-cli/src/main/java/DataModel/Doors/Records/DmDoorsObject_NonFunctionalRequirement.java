...
public class DmDoorsObject_NonFunctionalRequirement extends DmDoorsObject_Requirement {
    ...
    public DmDoorsObject_NonFunctionalRequirement(DoorsObject doorsObject) {
