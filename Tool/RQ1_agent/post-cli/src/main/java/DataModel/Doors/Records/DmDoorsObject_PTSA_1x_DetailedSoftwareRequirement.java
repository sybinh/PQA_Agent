...
public class DmDoorsObject_PTSA_1x_DetailedSoftwareRequirement extends DmDoorsObject_PTSA_1x_Requirement {
    ...
    public DmDoorsObject_PTSA_1x_DetailedSoftwareRequirement(DoorsObject doorsObject) {
        super(ElementType.DETAILED_SW_REQ, doorsObject);
