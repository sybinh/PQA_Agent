 ...
 * @author GUG2WI
 */
public class DmDoorsObject_PTSA_20_STKH_INFO extends DmDoorsObject_PTSA_20_STKH {

    final public DmConstantField_Text DESCRIPTION;
    final public DmConstantField_Text VAR_FUNC_SW;

    public DmDoorsObject_PTSA_20_STKH_INFO(DoorsObject doorsObject) {
        super(ElementType.PTSA_20_STKH_INFO, doorsObject);
