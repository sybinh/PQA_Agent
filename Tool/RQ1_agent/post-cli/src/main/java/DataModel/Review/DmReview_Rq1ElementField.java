 ...
 * @author cil83wi
 */
public class DmReview_Rq1ElementField extends DmElementField_ReadOnlyFromSource<DmRq1ElementInterface> {

    final private DmConstantField_Text idField;
    private boolean loadDone = false;
    private DmRq1ElementInterface element = null;

    public DmReview_Rq1ElementField(DmConstantField_Text idField, String nameForUserInterface) {
