 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_SupportTicket extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Support Ticket";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_SupportTicket(DsAlmRecord dsAlmRecord) {
