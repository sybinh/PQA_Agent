 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_DefectEval extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Defect Eval";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_DefectEval(DsAlmRecord dsAlmRecord) {
