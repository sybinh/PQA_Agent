 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_Commercial extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Commercial";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_Commercial(DsAlmRecord dsAlmRecord) {
