 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_LearningMilestone extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Learning Milestone";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_LearningMilestone(DsAlmRecord dsAlmRecord) {
