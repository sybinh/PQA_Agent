 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_FBDefect extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "FBDefect";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_FBDefect(DsAlmRecord dsAlmRecord) {
