 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_TrackBuildItem extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Track Build Item";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_TrackBuildItem(DsAlmRecord dsAlmRecord) {
