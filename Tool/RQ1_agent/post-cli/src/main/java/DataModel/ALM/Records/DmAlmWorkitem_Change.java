 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_Change extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Change";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_Change(DsAlmRecord dsAlmRecord) {
