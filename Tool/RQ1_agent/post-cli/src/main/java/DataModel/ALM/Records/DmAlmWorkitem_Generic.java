 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_Generic extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Generic";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_Generic(DsAlmRecord dsAlmRecord) {
