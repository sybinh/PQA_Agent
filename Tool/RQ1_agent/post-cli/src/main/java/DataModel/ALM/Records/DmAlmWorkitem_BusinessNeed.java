 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_BusinessNeed extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Business Need";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_BusinessNeed(DsAlmRecord dsAlmRecord) {
