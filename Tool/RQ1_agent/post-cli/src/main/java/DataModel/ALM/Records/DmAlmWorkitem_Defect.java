 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_Defect extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Defect";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_Defect(DsAlmRecord dsAlmRecord) {
