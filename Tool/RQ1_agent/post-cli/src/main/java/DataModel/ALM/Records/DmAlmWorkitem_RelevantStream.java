 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_RelevantStream extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Relevant Stream";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_RelevantStream(DsAlmRecord dsAlmRecord) {
