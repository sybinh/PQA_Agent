 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_ProgramEpic extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Program Epic";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_ProgramEpic(DsAlmRecord dsAlmRecord) {
