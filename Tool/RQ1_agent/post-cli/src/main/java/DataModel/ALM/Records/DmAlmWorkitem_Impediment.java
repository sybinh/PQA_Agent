 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_Impediment extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Impediment";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_Impediment(DsAlmRecord dsAlmRecord) {
