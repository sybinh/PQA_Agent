 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_Delivery extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Delivery";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_Delivery(DsAlmRecord dsAlmRecord) {
