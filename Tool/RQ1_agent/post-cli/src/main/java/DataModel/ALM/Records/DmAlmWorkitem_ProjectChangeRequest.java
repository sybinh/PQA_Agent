 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_ProjectChangeRequest extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Project Change Request";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_ProjectChangeRequest(DsAlmRecord dsAlmRecord) {
