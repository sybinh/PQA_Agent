 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_Retrospective extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Retrospective";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_Retrospective(DsAlmRecord dsAlmRecord) {
