 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_Improvement extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Improvement";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_Improvement(DsAlmRecord dsAlmRecord) {
