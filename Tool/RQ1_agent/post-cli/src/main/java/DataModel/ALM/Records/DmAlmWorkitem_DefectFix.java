 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_DefectFix extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Defect Fix";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_DefectFix(DsAlmRecord dsAlmRecord) {
