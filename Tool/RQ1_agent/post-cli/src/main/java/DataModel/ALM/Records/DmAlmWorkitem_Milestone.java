 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_Milestone extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Milestone";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_Milestone(DsAlmRecord dsAlmRecord) {
