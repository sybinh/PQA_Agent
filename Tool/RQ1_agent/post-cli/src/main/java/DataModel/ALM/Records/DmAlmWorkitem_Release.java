 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_Release extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Release";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_Release(DsAlmRecord dsAlmRecord) {
