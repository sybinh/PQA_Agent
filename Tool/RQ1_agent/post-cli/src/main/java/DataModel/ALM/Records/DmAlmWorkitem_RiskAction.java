 ...
 * @author CNI83WI
 */
public class DmAlmWorkitem_RiskAction extends DmAlmWorkitem {

    public static final String ELEMENT_TYPE = "Risk Action";

    final public DmAlmField_Text STATUS;
    final public DmAlmField_Text DESCRIPTION;

    public DmAlmWorkitem_RiskAction(DsAlmRecord dsAlmRecord) {
