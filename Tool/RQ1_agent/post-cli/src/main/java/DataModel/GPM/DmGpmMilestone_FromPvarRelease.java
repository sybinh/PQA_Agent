 ...
 * @author GUG2WI
 */
public class DmGpmMilestone_FromPvarRelease extends DmGpmMilestone_FromRelease<DmRq1PvarRelease> {

    DmGpmMilestone_FromPvarRelease(DmRq1PvarRelease pvar) {
        super(pvar, Type.PVAR, pvar.getClassificationAsText() + " Delivery");
    }
