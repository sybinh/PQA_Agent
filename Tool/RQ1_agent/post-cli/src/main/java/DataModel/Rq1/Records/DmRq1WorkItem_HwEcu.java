 ...
 * @author GUG2WI
 */
public class DmRq1WorkItem_HwEcu extends DmRq1WorkItem_Hardware {

    @IpeFactoryConstructor("DataModel.Rq1.Records.DmRq1Element")
    public DmRq1WorkItem_HwEcu(Rq1WorkItem_HwEcu rq1WorkItem) {
        super("Workitem-HW-ECU", rq1WorkItem);
    }

    private static DmRq1WorkItem_HwEcu create() {
        Rq1WorkItem_HwEcu rq1Record = new Rq1WorkItem_HwEcu();
        DmRq1WorkItem_HwEcu dmRecord = new DmRq1WorkItem_HwEcu(rq1Record);
        DmRq1ElementCache.addElement(rq1Record, dmRecord);
        return (dmRecord);
    }

    public static DmRq1WorkItem_HwEcu createBasedOnRelease(DmRq1EcuRelease release, DmRq1Project targetProject, Rq1TemplateI template) {
        return (createBasedOnRelease(release, targetProject, template, EnumSet.noneOf(TitleSuffix.class), null));
    }

    public static DmRq1WorkItem_HwEcu createBasedOnRelease(DmRq1EcuRelease release, DmRq1Project targetProject, Rq1TemplateI template, EnumSet<TitleSuffix> suffixSet, String suffixSeparator) {
        assert (release != null);
        assert (targetProject != null);

        DmRq1WorkItem_HwEcu workItem = create();
        String suffix;
    ...
    public static DmRq1WorkItem_HwEcu createBasedonWorkItem(DmRq1WorkItem workItem) {
        assert (workItem != null);

        DmRq1WorkItem_HwEcu clonedWorkItem = create();

        //
        // takeover content from workItem
        //
        clonedWorkItem = (DmRq1WorkItem_HwEcu) cloneBasicContentofWorkItem(workItem, clonedWorkItem);
