 ...
 * @author GUG2WI
 */
public class DmRq1PvarCollection extends DmRq1Pvar implements DmRq1PstCollectionI {

    final public DmRq1Field_Enumeration CLASSIFICATION;
    public static final String ELEMENTTYPE = "PVAR-Collection";

    @IpeFactoryConstructor("DataModel.Rq1.Records.DmRq1Element")
    public DmRq1PvarCollection(Rq1PvarCollection rq1Pst) {
    ...
    public static DmRq1PvarCollection create() {
        Rq1PvarCollection rq1Record = new Rq1PvarCollection();
        DmRq1PvarCollection dmElement = new DmRq1PvarCollection(rq1Record);
        DmRq1ElementCache.addElement(rq1Record, dmElement);
        return (dmElement);
    }

    public static DmRq1PvarCollection createBasedOnCustomerProject(DmRq1SwCustomerProject project) {
        assert (project != null);

        DmRq1PvarCollection collection = create();
