 ...
 * @author GUG2WI
 */
public class DmRq1WorkItem_IssueHwEcu extends DmRq1WorkItem_Hardware {

    @IpeFactoryConstructor("DataModel.Rq1.Records.DmRq1Element")
    public DmRq1WorkItem_IssueHwEcu(Rq1WorkItem_IssueHwEcu rq1WorkItem) {
        super("Workitem-I-HW-ECU", rq1WorkItem);
    }

    private static DmRq1WorkItem_IssueHwEcu create() {
        Rq1WorkItem_IssueHwEcu rq1Record = new Rq1WorkItem_IssueHwEcu();
        DmRq1WorkItem_IssueHwEcu dmRecord = new DmRq1WorkItem_IssueHwEcu(rq1Record);
        DmRq1ElementCache.addElement(rq1Record, dmRecord);
        return (dmRecord);
    }

    public static DmRq1WorkItem_IssueHwEcu createBasedOnIssue(DmRq1IssueHwEcu issue, DmRq1Project targetProject, Rq1TemplateI template) {
        return (createBasedOnIssue(issue, targetProject, template, EnumSet.noneOf(TitleSuffix.class), null));
    }

    public static DmRq1WorkItem_IssueHwEcu createBasedOnIssue(DmRq1IssueHwEcu issue, DmRq1Project targetProject, Rq1TemplateI template, EnumSet<TitleSuffix> suffixSet, String suffixSeparator) {
        assert (issue != null);
        assert (targetProject != null);

        DmRq1WorkItem_IssueHwEcu workItem = create();
        String suffix;
    ...
    public static DmRq1WorkItem_IssueHwEcu createBasedonWorkItem(DmRq1WorkItem workItem) {
        assert (workItem != null);

        DmRq1WorkItem_IssueHwEcu clonedWorkItem = create();

        //
        // takeover content from workItem
        //
        clonedWorkItem = (DmRq1WorkItem_IssueHwEcu) cloneBasicContentofWorkItem(workItem, clonedWorkItem);
