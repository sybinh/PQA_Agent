 ...
 * @author gug2wi
 */
public class Rule_Irm_PstRelease_IssueSw_Severity extends DmRule<DmRq1Irm_Pst_IssueSw> {
    ...
    public void executeRule() {
        ...
        if (issue instanceof DmRq1IssueSW) {
            ...
            if (((DmRq1IssueSW) issue).SEVERITY.getValue() == Severity.HIGH) {
                if ((dmElement.PRIORITY.getValue() != Priority.HIGH) && (dmElement.PRIORITY_COMMENT.getValueAsText().isEmpty() == true)) {
