 ...
 * @author gug2wi
 */
public class Rule_UnknownProject_Exists extends DmRule<DmRq1UnknownProject> {
    ...
    public void executeRule() {
        dmElement.setMarker(new Warning(this, "Unknown Project Type", "Unknown Project Type"));
    }
}
