 ...
 * @author gug2wi
 */
public class DmRq1Field_RequirementsOnBc extends DmRq1Field_RequirementsOnRelease {

    final private DmRq1Bc bcRelease;

    public DmRq1Field_RequirementsOnBc(DmRq1Bc parent, String nameForUserInterface) {
