 ...
 * @author GUG2WI
 */
public class DmRq1WorkItem_HwMod extends DmRq1WorkItem_Hardware {

    @IpeFactoryConstructor("DataModel.Rq1.Records.DmRq1Element")
    public DmRq1WorkItem_HwMod(Rq1WorkItem_HwMod rq1WorkItem) {
        super("Workitem-HW-MOD", rq1WorkItem);
    }

    private static DmRq1WorkItem_HwMod create() {
        Rq1WorkItem_HwMod rq1Record = new Rq1WorkItem_HwMod();
        DmRq1WorkItem_HwMod dmRecord = new DmRq1WorkItem_HwMod(rq1Record);
        DmRq1ElementCache.addElement(rq1Record, dmRecord);
        return (dmRecord);
    }

    public static DmRq1WorkItem_HwMod createBasedOnRelease(DmRq1ModRelease release, DmRq1Project targetProject, Rq1TemplateI template) {
        return (createBasedOnRelease(release, targetProject, template, EnumSet.noneOf(TitleSuffix.class), null));
    }

    public static DmRq1WorkItem_HwMod createBasedOnRelease(DmRq1ModRelease release, DmRq1Project targetProject, Rq1TemplateI template, EnumSet<TitleSuffix> suffixSet, String suffixSeparator) {
        assert (release != null);
        assert (targetProject != null);

        DmRq1WorkItem_HwMod workItem = create();
        String suffix;
    ...
    public static DmRq1WorkItem_HwMod createBasedonWorkItem(DmRq1WorkItem workItem) {
        assert (workItem != null);

        DmRq1WorkItem_HwMod clonedWorkItem = create();

        //
        // takeover content from workItem
        //
        clonedWorkItem = (DmRq1WorkItem_HwMod) cloneBasicContentofWorkItem(workItem, clonedWorkItem);
