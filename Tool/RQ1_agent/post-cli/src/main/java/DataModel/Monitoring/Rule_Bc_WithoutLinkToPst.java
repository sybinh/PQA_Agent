 ...
 * @author gug2wi
 */
public class Rule_Bc_WithoutLinkToPst extends DmRule {
    ...
    final protected DmRq1BcRelease myRelease;
    ...
    public void executeRule() {
        ...
        if (myRelease.MAPPED_PST.getElementList().isEmpty() == true) {
            addMarker(myRelease, new Warning(this, "BC not linked to any PVER/PFAM.", "BC not linked to any PVER/PFAM."));
        }
    }
