 ...
 */
public class Rule_Bc_CheckPstDates extends DmRule {
    ...
    public void executeRule() {
        ...
        //
        for (DmMappedElement<DmRq1Rrm, DmRq1Pst> mappedPst : myRelease.MAPPED_PST.getElementList()) {
            ...
            if (mappedPst.getMap() instanceof DmRq1Rrm_Pst_Bc || mappedPst.getTarget() instanceof DmRq1PstReleaseI) {
                ...
                if ((rrmReqDate != null) && (rrmReqDate.isEmpty() == false)) {
                    if (rrmReqDate.isEarlierThen(myRelease.PLANNED_DATE.getValue()) == true) {
                        addMarker(myRelease, new Warning(this, "BC too late for PST",
