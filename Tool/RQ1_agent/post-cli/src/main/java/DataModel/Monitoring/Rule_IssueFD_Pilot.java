 ...
 * @author sas82wi
 */
public class Rule_IssueFD_Pilot extends DmRule {
    ...
    public void executeRule() {
        ...
        addDependency(issueFD.PARENT);
        DmRq1Issue parent = issueFD.PARENT.getElement();
        ...
        if (parent instanceof DmRq1IssueSW) {
            ...
            if (hasPilot == false) {
                addMarker(issueFD, new Warning(this, PILOT_MISSING, "No pilot release exists for the parent I-SW of the I-FD."));
            }

        } else {
            addMarker(issueFD, new Warning(this, I_SW_MISSING, "The I-FD has no parent I-SW."));
        }
    }
