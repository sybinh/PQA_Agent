 ...
 * @author gug2wi
 */
public class Rule_CheckDatesForBcAndFc extends DmRule {
    ...
    static final public DmRq1RuleDescription description = new DmRq1RuleDescription(
            ...
            "Check dates for BC and FC.",
            "The dates for BC and FC are checked against the following rules:\n"
            + "\n"
            ...
            + "- Planned Date must be set.\n"
            + "\n"
            // Covered by QAM ID-2.5.0            + "For life cycle state DEVELOPED:\n"
            // Covered by QAM ID-2.5.0            + "- Planned Date must be set and in the future or today.\n"
            + "\n"
    ...
    public Rule_CheckDatesForBcAndFc(DmRq1BcRelease bcRelease) {
        super(description, bcRelease);
        this.myRelease = bcRelease;
    }

    public Rule_CheckDatesForBcAndFc(DmRq1FcRelease fcRelease) {
        super(description, fcRelease);
        this.myRelease = fcRelease;
    }
