 ...
 * @author gug2wi
 */
public class Rule_IssueSW_ASIL extends DmRule {
    ...
    public void executeRule() {
        ...
        //
        if (myIssueSw.isInLifeCycleState(LifeCycleState_Issue.NEW,
        ...
        //
        AsilClassification asilOnI_SW = AsilClassification.get(myIssueSw.ASIL_CLASSIFICATION.getValueAsText());
        if (asilOnI_SW == null) {
            addMarker(myIssueSw, new Warning(this, "ASIL level missing for I-SW.", "The ASIL level set for the I-SW is not a valid one."));
            return;
        }
        ...
        //
        if (myIssueSw.CHILDREN.getElementList().isEmpty() == true) {
            return;
        }
        ...
        //
        for (DmRq1IssueFD i_fd : myIssueSw.CHILDREN.getElementList()) {
            addDependency(i_fd);
        ...
        addMarker(myIssueSw, new Warning(this, "ASIL level on I-FD not sufficient for I-SW", b.toString()));
