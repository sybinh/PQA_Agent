 ...
 * @author gug2wi
 */
public class Rule_IssueSW_MissingAffectedIssueComment extends DmRule {
    ...
    final private DmRq1IssueSW myIssue;
    ...
    public void executeRule() {
        ...
        //
        if (myIssue.CATEGORY.getValue() != SoftwareIssueCategory.DEFECT) {
            return;
        }
        ...
        //
        if (myIssue.SCOPE.getValue() != Scope.EXTERNAL) {
            return;
        }
        ...
        //
        if (myIssue.AFFECTED_ISSUE_COMMENT.isEmpty() == false) {
            return;
        }
        ...
        //
        if (myIssue.SUBMIT_DATE.getValue().isEarlierThen(EcvDate.getDate(2017, 2, 1))) {
            return;
        }
        ...
        //
        if (myIssue.AFFECTED_ISSUE.isElementSet() == true) {
            return;
        }
        ...
        //
        DmRq1Project project = myIssue.PROJECT.getElement();
        ...
        // Add warning
        //
        addMarker(myIssue, new Warning(this, "Missing affected issue comment", "No affected issue is set and not comment for affected issue is given."));
