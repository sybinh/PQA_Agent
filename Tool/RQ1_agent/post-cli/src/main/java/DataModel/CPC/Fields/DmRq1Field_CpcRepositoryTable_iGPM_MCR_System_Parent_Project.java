...
import Rq1Data.CPC.CpcXmlTable_iGPM_MCR_System_Parent_Project.CpcIGpmMcrData;
 ...
 * @author fuj1wi
 */
public class DmRq1Field_CpcRepositoryTable_iGPM_MCR_System_Parent_Project extends DmRq1Field_CpcRepositoryTable<CpcXmlTable_iGPM_MCR_System_Parent_Project, CpcIGpmMcrData> {
    
    public DmRq1Field_CpcRepositoryTable_iGPM_MCR_System_Parent_Project(DmRq1Project project, Rq1XmlSubField_Table<CpcXmlTable_iGPM_MCR_System_Parent_Project> cpcField, String nameForUserInterface, String descriptionForUI) {
    ...
    public List<CpcIGpmMcrData> getDataList() {
        ...
        List<CpcIGpmMcrData> repositoryDataList = CpcXmlTable_iGPM_MCR_System_Parent_Project.DESC.extract(tableData);
    ...
    public void setValueAsList(List<CpcIGpmMcrData> dataList) {
        ...
        EcvTableData tableData = CpcXmlTable_iGPM_MCR_System_Parent_Project.DESC.pack(dataList);
        setValue(tableData);
    }
}
