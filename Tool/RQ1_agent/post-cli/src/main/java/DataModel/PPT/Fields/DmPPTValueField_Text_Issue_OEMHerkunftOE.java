 ...
 * @author moe83wi
 */
public class DmPPTValueField_Text_Issue_OEMHerkunftOE extends DmPPTValueField_Text {

    public DmPPTValueField_Text_Issue_OEMHerkunftOE(DmPPTAenderung parent, DmRq1IssueSW issueRQ1, DmPPTBCRelease bc, DmPPTFCRelease fc, String nameForUserInterface) {
