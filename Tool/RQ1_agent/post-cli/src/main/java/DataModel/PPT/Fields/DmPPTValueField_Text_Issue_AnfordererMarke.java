 ...
 * @author moe83wi
 */
public class DmPPTValueField_Text_Issue_AnfordererMarke extends DmPPTValueField_Text {

    public DmPPTValueField_Text_Issue_AnfordererMarke(DmPPTAenderung parent, DmRq1IssueSW issueRQ1, DmPPTBCRelease bc, DmPPTFCRelease fc, String nameForUserInterface) {
    ...
    public static String calcValue(DmPPTAenderung parent, DmRq1IssueSW issueRQ1, DmPPTBCRelease bc, DmPPTFCRelease fc) {
        ...
        if (issueRQ1 != null) { //the issue exists in RQ1
            if (issueRQ1.EXTERNAL_ASSIGNEE_ORGANIZATION != null && ! issueRQ1.EXTERNAL_ASSIGNEE_ORGANIZATION.isEmpty()) {
