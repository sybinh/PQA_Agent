 ...
 * @author moe83wi
 */
public class DmPPTField_Reference_BCRelease_IssuesFDs extends DmPPTField_ReferenceList<DmRq1IssueFD> {

    private final DmRq1Field_MappedReferenceList<DmRq1Irm, DmRq1Issue> ISSUES;
    private final DmPPTBCRelease BC;

    public DmPPTField_Reference_BCRelease_IssuesFDs(DmPPTBCRelease parent,
    ...
    public boolean containsIssue(DmRq1IssueFD givenIssue) {
        getElementList();
