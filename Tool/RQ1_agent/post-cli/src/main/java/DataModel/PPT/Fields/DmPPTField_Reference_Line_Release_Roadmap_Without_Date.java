 ...
 * @author moe83wi
 */
public class DmPPTField_Reference_Line_Release_Roadmap_Without_Date extends DmPPTField_ReferenceList<DmPPTRelease> {

    private final DmPPTCustomerProject PPT_PROJECT;
    private final DmPPTLine LINE;

    public DmPPTField_Reference_Line_Release_Roadmap_Without_Date(DmPPTLine parent, DmPPTCustomerProject element, String nameForUserInterface) {
    ...
    public List<DmPPTRelease> getElementList() {
        if (element.isEmpty()) {
            for ( DmRq1Pst release : PPT_PROJECT.getPST_RELEASES_ROADMAP_WITHOUT_DATE().getElementList()) {
