...
import DataStore.DsField_XmlSubField_Text;
 ...
 * @author GUG2WI
 */
public class Rq1XmlSubField_Text extends DsField_XmlSubField_Text<Rq1RecordInterface> implements Rq1FieldI_Text {

    public Rq1XmlSubField_Text(Rq1RecordInterface parent, DsField_XmlSourceI source, String elementName) {
