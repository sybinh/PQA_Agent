 ...
 * @author gug2wi
 */
public class Rq1XmlTableColumn_String extends EcvTableColumn_String implements Rq1XmlTableColumn<String> {

    final String sourceName;
    private List<String> alternativSourceNames = null;
    final Rq1XmlTable.ColumnEncodingMethod encodingMethod;

    public Rq1XmlTableColumn_String(String uiName, String sourceName, ColumnEncodingMethod encodingMethod) {
        super(uiName);
    ...
    public Rq1XmlTableColumn_String(String uiName, int columnWidth, ColumnEncodingMethod encodingMethod) {
    ...
    public Rq1XmlTableColumn_String(String uiName, int columnWidth, String sourceName, ColumnEncodingMethod encodingMethod) {
        super(uiName, columnWidth);
        assert (encodingMethod != null);
        assert (sourceName != null);
        assert (sourceName.isEmpty() == false);
