 ...
 * @author GUG2WI
 */
public class Rq1WorkItem_DevPrj extends Rq1WorkItem_Project {

    public Rq1WorkItem_DevPrj() {
        super(Rq1NodeDescription.WORKITEM_DEV_PRJ, Domain_WorkItem.SOFTWARE, SubCategory_WorkItem.DEV_PRJ);
    }
