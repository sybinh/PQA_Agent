 ...
 * @author gug2wi
 */
public class Rq1Irm_Unknown_IssueSw extends Rq1Irm {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Rq1Irm_Unknown_IssueSw.class.getCanonicalName());

    public Rq1Irm_Unknown_IssueSw() {
        super(Rq1LinkDescription.IRM_UNKNOWN_ISSUE_SW);
    }
