 ...
 * @author GUG2WI
 */
public class Rq1WorkItem_RefPrj extends Rq1WorkItem_Project {

    public Rq1WorkItem_RefPrj() {
        super(Rq1NodeDescription.WORKITEM_REF_PRJ, Domain_WorkItem.SOFTWARE, SubCategory_WorkItem.REF_PRJ);
    }
