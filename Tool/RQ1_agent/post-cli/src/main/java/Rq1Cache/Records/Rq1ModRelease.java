...
import Rq1Data.Enumerations.HardwareModReleaseClassification;

/**
 *
 * @author gug2wi
 */
public class Rq1ModRelease extends Rq1HardwareRelease {
    ...
    public Rq1ModRelease() {
        super(Rq1NodeDescription.HW_MOD_RELEASE);

        addField(CLASSIFICATION = new Rq1DatabaseField_Enumeration(this, "Classification", HardwareModReleaseClassification.values()));
